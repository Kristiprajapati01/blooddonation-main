    ...
    <section class="ml-64 px-4">
        <div class="bg-white p-6 rounded-lg shadow-lg">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
                ...
                <!-- Blood Requests -->
                <div class="bg-red-600 text-white p-6 rounded-lg shadow-md hover:shadow-lg transition duration-200">
                    <h3 class="text-xl font-semibold">Blood Requests</h3>
                    <p class="text-2xl font-bold"><?php echo htmlspecialchars($totalPendingRequests); ?></p>
                </div>

                <!-- Total Donations -->
                <div class="bg-red-400 text-white p-6 rounded-lg shadow-md hover:shadow-lg transition duration-200">
                    <h3 class="text-xl font-semibold">Total Donations</h3>
                    <p class="text-2xl font-bold"><?php echo htmlspecialchars($totalDonations); ?></p>
                </div>

                <!-- Availability Status -->
                <div class="text-white p-6 rounded-lg shadow-md hover:shadow-lg transition duration-200 <?php echo ($availabilityStatus === 'Available') ? 'bg-green-500' : 'bg-red-500'; ?>">
                    <h3 class="text-xl font-semibold">Availability Status</h3>
                    <p class="text-xl font-bold">
                        <?php echo htmlspecialchars($availabilityStatus === "Available" ? "Available" : "Donate after $daysUntilEligible days"); ?>
                    </p>
                </div>
