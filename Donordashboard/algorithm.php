...
function recommendBloodBanks($userId, $similarUsers, $userInteractions) {
    ...
    foreach ($similarUsers as $similarUserId => $similarData) {
        ...
        foreach ($similarInteractions as $bloodBankId => $interactionValue) {
            // Allow recommending even if the logged-in user has already interacted with the blood bank
    ...
    // Sort by highest weighted scores
    arsort($recommendedBloodBanks);

    // Debugging output to check which blood banks are recommended
    // echo "<pre>";
    // print_r($recommendedBloodBanks);
    // echo "</pre>";
...
// echo "<pre>";
// print_r($userInteractions);
// print_r($similarUsers);
// print_r($recommendedBloodBanks);
// echo "</pre>";
