            ...
            <div class="px-4 mt-10 w-2/3">
                <div class="flex-cols gap-2">
                   ...
                   <h2 class="text-3xl text-center text-black font-semibold mb-4">Blood Bank Information</h2>
                    ...
                    <div class="bg-white shadow-md p-6 mt-4">
                    <h2 class="text-3xl text-center text-red-600 font-semibold mb-4">Available Blood Groups</h2>
                    <table class="min-w-full table-auto border-collapse border border-red-600">
                    <thead>
                    ...
                    <th class="border border-gray-400 px-4 py-2">Available Quantity</th>
                        ...
                        <a href="request_bloodTobank.php?id=<?= $bloodBankId; ?>" class="mt-4 inline-block bg-red-500 text-white px-4 py-2 rounded">Request Blood</a>
                            <?php endif;?>
                    </div>
