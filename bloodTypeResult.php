                            ...
                            <div class="bg-white shadow-md rounded-lg p-6 text-center">
                                ...
                                if (isset($_SESSION['Uloggedin']) && $_SESSION['Uloggedin'] == true) {
                                    ...
                                    <form action="request_donation.php" method="POST">
                                        ...
                                        <button type="submit" class="mt-4 inline-block bg-red-500 text-white px-4 py-2 rounded-lg hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500">
                                            Request Blood
                                        </button>
                                    </form>
                                    ';
