...
<body class="bg-gray-100 font-sans antialiased">
    ...
    <nav class="flex-1">
        <!-- Dashboard Section -->
        <div class="px-4 py-2 border-b border-red-600">
            <h2 class="text-red-600 text-sm font-semibold mb-2">BloodBank Dashboard</h2>
            <ul class="space-y-2">
                <li>
        ...
        <div class="px-4 py-2 border-b border-red-600">
            <h2 class="text-red-600 text-sm font-semibold mb-2">Blood Details</h2>
            <ul class="space-y-2">
                <li>
                    <a href="addBlood.php"
                       class="flex items-center px-4 py-2 text-gray-700 hover:bg-red-100 hover:text-red-600 rounded-lg transition duration-150">
        ...
        <div class="px-4 py-2 border-b border-red-600">
            <h2 class="text-red-600 text-sm font-semibold mb-2">Campaign Details</h2>
            <ul class="space-y-2">
                <li>
    ...
    <section class="ml-72 p-8">
        <div class="bg-white p-4 rounded-lg shadow-lg flex items-center justify-between">
            <h1 class="text-2xl font-bold text-gray-800">
                Welcome to BloodLink &nbsp;<span class="text-red-600"><?php echo htmlspecialchars($_SESSION['bankname']); ?></span>
            </h1>
