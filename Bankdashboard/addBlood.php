    ...
    <section class="ml-72 p-8 max-w-4xl">
        ...
        <div class="bg-white p-8 rounded-lg shadow-lg">
            ...
            <form role="form" action="" method="post">
                            <div class="mb-6">
                    <label class="block text-red-600 font-semibold mb-2" for="name">Enter Donor Name</label>
                    <input class="shadow-lg border rounded w-full p-3 text-gray-800 focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent"
                        type="text" placeholder="Donor name" name="name" required>
                </div>

                <div class="mb-6">
                    <label class="block text-red-600 font-semibold mb-2" for="gender">Gender</label>
                    <select class="shadow-lg border rounded w-full p-3 text-gray-800 focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent"
                ...
                <div class="mb-6">
                    <label class="block text-red-600 font-semibold mb-2" for="dob">Enter Date of Birth</label>
                    <input class="shadow-lg border rounded w-full p-3 text-gray-800 focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent"
                        type="date" name="dob" required>
                </div>

                <div class="mb-6">
                    <label class="block text-red-600 font-semibold mb-2" for="weight">Enter Weight (kg)</label>
                    <input class="shadow-lg border rounded w-full p-3 text-gray-800 focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent"
                        placeholder="Enter donor weight" type="number" name="weight" required>
                </div>

                <div class="mb-6">
                    <label class="block text-red-600 font-semibold mb-2" for="bloodgroup">Select Blood Group</label>
                    <select name="bloodgroup" id="donorBloodgroup" required
                            class="shadow-lg border rounded w-full p-3 text-gray-800 focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent">
                ...
                <div class="mb-6">
                    <label class="block text-red-600 font-semibold mb-2" for="bloodqty">Blood Quantity (ml)</label>
                    <input class="shadow-lg border rounded w-full p-3 text-gray-800 focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent"
                        placeholder="Enter blood quantity" type="number" name="bloodqty" max="500" min="100" required>
                </div>

                <div class="mb-6">
                    <label class="block text-red-600 font-semibold mb-2" for="address">Enter Address</label>
                    <input class="shadow-lg border rounded w-full p-3 text-gray-800 focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent"
                        placeholder="Enter address" type="text" name="address" required>
                </div>

                <div class="mb-6">
                    <label class="block text-red-600 font-semibold mb-2" for="contact">Enter Contact Number</label>
                    <input class="shadow-lg border rounded w-full p-3 text-gray-800 focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent"
                        placeholder="Donor contact number" type="number" name="contact" required>
                </div>

                <div class="mb-6">
                    <label class="block text-red-600 font-semibold mb-2" for="collection">Collection Date</label>
                    <input class="shadow-lg border rounded w-full p-3 text-gray-800 focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent"
                ...
                <div class="flex items-center justify-center">
                    <button type="submit"
                            class="px-16 py-3 rounded-full bg-red-600 hover:bg-red-700 text-white font-bold shadow-lg focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-opacity-50 transition duration-150 ease-in-out">
                        Submit
                    </button>
                </div>
