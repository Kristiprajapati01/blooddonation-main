...
<section class="ml-72 p-8">
    ...
    <thead>
        <tr class="bg-red-600 text-white">
            <th class="px-4 py-2 border border-red-300">Blood Group</th>
            <th class="px-4 py-2 border border-red-300">Name</th>
            <th class="px-4 py-2 border border-red-300">Gender</th>
            <th class="px-4 py-2 border border-red-300">Date of Birth</th>
            <th class="px-4 py-2 border border-red-300">Weight</th>
            <th class="px-4 py-2 border border-red-300">Address</th>
            <th class="px-4 py-2 border border-red-300">Contact</th>
            <th class="px-4 py-2 border border-red-300">Blood Quantity</th>
            <th class="px-4 py-2 border border-red-300">Collection Date</th>
            <th class="px-4 py-2 border border-red-300">Expire In</th>
            <th class="px-4 py-2 border border-red-300">Actions</th>
        </tr>
        </thead>
        <tbody>
