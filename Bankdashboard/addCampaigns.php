...
<body class="bg-gray-200">
    ...
    <section class="ml-72 p-8 max-w-4xl">
        <div class="bg-white p-8 rounded-lg shadow-lg">
            ...
            <div class="mb-4">
    <label class="block text-red-600 font-bold mb-2" for="campaignName">Campaign Name</label>
    <input
        id="campaignName"
        class="shadow border rounded w-full p-2 text-gray-700 focus:outline-none focus:ring-2 focus:ring-red-500"
        type="text" placeholder="Enter Campaign's Name" name="campaign_name" required>
</div>

<div class="mb-4">
    <label class="block text-red-600 font-bold mb-2" for="contactNumber">Contact Number</label>
    <input
        id="contactNumber"
        class="shadow border rounded w-full p-2 text-gray-700 focus:outline-none focus:ring-2 focus:ring-red-500"
...
<div class="mb-4">
    <label class="block text-red-600 font-bold mb-2" for="campaignDate">Campaign Date</label>
    <input
        id="campaignDate"
        class="shadow border rounded w-full p-2 text-gray-700  focus:outline-none focus:ring-2 focus:ring-red-500"
...
<div class="mb-4">
    <label for="location" class="block text-red-600 font-bold">Address</label>
    <input id="location" type="text" name="location" placeholder="Enter campaign address" required class="w-full p-2 border border-gray-300 rounded text-gray-700  focus:outline-none focus:ring-2 focus:ring-red-500">
...
<div class="flex items-center justify-center">
    <button type="submit"
        class="px-20 rounded-full bg-red-500 hover:bg-red-700 text-white font-bold py-3 focus:outline-none focus:ring-2 focus:ring-red-500">Submit</button>
</div>
            </form>
        </div>
    </section>
